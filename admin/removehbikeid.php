...
<!-- Document Wrapper
	...
	<?php  ?>
		...
		<section>
		<form method="get" action="removehbike.php">
				...
				<div class="container clearfix">
					...
					<div class="center">
						<div class="topmargin">
							...
							<br>
							<div class="center">
							<label for="template-contactform-message">Enter the Heavy Bike Post ID to Remove <small>*</small></label>
							<br>
							<br>
					...
					<br><br>
					<center>
					<a href="removeallbikes.php" class="button ">Remove All Heavy Bike Posts...?? </a>
					</center>
