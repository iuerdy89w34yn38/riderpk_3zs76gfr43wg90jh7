...
<!-- Document Wrapper
	...
	<?php  ?>
		...
		<section>
		<form method="get" action="removecar.php">
				...
				<div class="container clearfix">
					...
					<div class="center">
						<div class="topmargin">
							...
							<br>
							<div class="center">
							<label for="template-contactform-message">Enter the Car Post ID to Remove <small>*</small></label>
							<br>
							<br>
					...
					<br><br>
					<center>
					<a href="removeallcars.php" class="button ">Remove All Car Posts...?? </a>
					</center>
