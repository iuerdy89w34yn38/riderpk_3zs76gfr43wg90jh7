...
<!-- Document Wrapper
	...
	if ($imaget=="image/jpeg"or$imaget=="image/png"or$imaget=="image/gif"or$imaget1=="image/jpeg"or$imaget1=="image/png"or$imaget1=="image/gif"or$imaget2=="image/jpeg"or$imaget2=="image/png"or$imaget2=="image/gif"){
		...
		if (!empty($imagenn)) {
			...
			$data=mysqli_query($con,"UPDATE `bikeposts` SET `img1` = '$imagenn' WHERE `bikeposts`.`post_id` = $id")or die( mysql_error() );
			$data=mysqli_query($con,"UPDATE `bikeposts` SET `img1thumb` = '$imagennthumb' WHERE `bikeposts`.`post_id` = $id")or die( mysql_error() );
		...
		if (!empty($imagenn1)) {
			...
			$data=mysqli_query($con,"UPDATE `bikeposts` SET `img2` = '$imagenn1' WHERE `bikeposts`.`post_id` = $id")or die( mysql_error() );
			$data=mysqli_query($con,"UPDATE `bikeposts` SET `img2thumb` = '$imagenn1thumb' WHERE `bikeposts`.`post_id` = $id")or die( mysql_error() );
		...
		if (!empty($imagenn2)) {
			...
			$data=mysqli_query($con,"UPDATE `bikeposts` SET `img3` = '$imagenn2' WHERE `bikeposts`.`post_id` = $id")or die( mysql_error() );
			$data=mysqli_query($con,"UPDATE `bikeposts` SET `img3thumb` = '$imagenn2thumb' WHERE `bikeposts`.`post_id` = $id")or die( mysql_error() );
