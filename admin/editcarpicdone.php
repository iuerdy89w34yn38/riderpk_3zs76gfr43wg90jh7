...
<!-- Document Wrapper
	...
	while($row=mysqli_fetch_array($rows)){
		...
		$file1="../images/cars/large/$imagen";
		$file1thumb="../images/cars/thumb/$imagenthumb";
		$file2="../images/cars/large/$imagen1";
		$file2thumb="../images/cars/thumb/$imagen1thumb";
		$file3="../images/cars/large/$imagen2";
		$file3thumb="../images/cars/thumb/$imagen2thumb";
	...
	if ($imaget=="image/jpeg"or$imaget=="image/png"or$imaget=="image/gif"or$imaget1=="image/jpeg"or$imaget1=="image/png"or$imaget1=="image/gif"or$imaget2=="image/jpeg"or$imaget2=="image/png"or$imaget2=="image/gif"){
		...
		if (!empty($imagenn)) {
			...
			$data=mysqli_query($con,"UPDATE `carposts` SET `img1` = '$imagenn' WHERE `carposts`.`post_id` = $id")or die( mysql_error() );
			$data=mysqli_query($con,"UPDATE `carposts` SET `img1thumb` = '$imagennthumb' WHERE `carposts`.`post_id` = $id")or die( mysql_error() );
		...
		if (!empty($imagenn1)) {
			...
			$data=mysqli_query($con,"UPDATE `carposts` SET `img2` = '$imagenn1' WHERE `carposts`.`post_id` = $id")or die( mysql_error() );
			$data=mysqli_query($con,"UPDATE `carposts` SET `img2thumb` = '$imagenn1thumb' WHERE `carposts`.`post_id` = $id")or die( mysql_error() );
		...
		if (!empty($imagenn2)) {
			...
			$data=mysqli_query($con,"UPDATE `carposts` SET `img3` = '$imagenn2' WHERE `carposts`.`post_id` = $id")or die( mysql_error() );
			$data=mysqli_query($con,"UPDATE `carposts` SET `img3thumb` = '$imagenn2thumb' WHERE `carposts`.`post_id` = $id")or die( mysql_error() );
