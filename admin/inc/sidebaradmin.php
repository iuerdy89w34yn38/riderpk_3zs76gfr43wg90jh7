				...
				<div style="font-size:25px;">
					Menu <br>
						  ...
						  <div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse <?php if( $sblink=="dashboard" ) echo "in" ; ?> ">
							  <div class="panel-body">
								...
								<br>
								<i style="font-size:15px;margin-right:5px;" class="toggle-open icon-wrench" > </i><a   href="#">Vist Site</a><br>
						  ...
						  <div class="panel panel-default">
							...
							<div id="collapseTwo" class="panel-collapse collapse <?php if( $sblink=="carpost") echo "in";  if( $sblink=="carid")  echo "in" ; if( $sblink=="removecarid")  echo "in" ;  ?> ">
							  <div class="panel-body">
								...
								<i style="font-size:15px;margin-right:5px;" class="toggle-open icon-wrench" > </i><a href="?link=removecarid">Remove Car Post</a><br>
						  ...
						  <div class="panel panel-default">
							...
							<div id="collapseThree" class="panel-collapse collapse  <?php if( $sblink=="bikepost")  echo "in" ;  if( $sblink=="bikeid")  echo "in" ;  if( $sblink=="removebikeid")  echo "in" ;  ?> ">
							  <div class="panel-body">
								...
								<i style="font-size:15px;margin-right:5px;" class="toggle-open icon-wrench" > </i><a href="?link=removebikeid">Remove Bike Post</a><br>
						  ...
						  <div class="panel panel-default">
							...
							<div id="collapseFour" class="panel-collapse collapse <?php 	 if( $sblink=="heavybikepost")  echo "in" ;  if( $sblink=="hbikeid")  echo "in" ;  if( $sblink=="removehbikeid")  echo "in" ;  ?> ">
							  <div class="panel-body">
								...
								<i style="font-size:15px;margin-right:5px;" class="toggle-open icon-wrench" > </i><a href="?link=removehbikeid">Remove Heavy Bikes Post</a><br>
