...
<!-- Document Wrapper
	...
	<form method="post" action="editcarpicdone.php?carid=<?php echo "$id"; ?>" enctype="multipart/form-data">
		...
		?>
					...
					<div class=" nobottommargin clearfix">
						...
						<div class="center topmargin-sm">
								<img src="../images/cars/large/<?php echo "$imagen"; ?>" >
								<br>
						...
						<div class="row">	
							...
							<div class="col-md-6 topmargin-sm bottommargin-sm">
								...
								<img src="../images/cars/large/<?php echo "$imagen1"; ?>" >
							...
							<div class="col-md-6 topmargin-sm bottommargin-sm">
								...
								<img src="../images/cars/large/<?php echo "$imagen2"; ?>" >
