...
<!-- Document Wrapper
	...
	<form method="post" action="editbikedespdone.php?bikeid=<?php echo "$id"; ?>" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<h4> Price Max </h4>
							...
							<div class="col-md-3 bottommargin-sm">
								...
								<input type="text" class="required sm-form-control" id="" name="pmaxt" rows="1"  value="<?php echo "$pmaxt" ; ?>">
						...
						<div class="row">	
							...
							<div class="col-md-4 bottommargin-sm">
								...
								<input type="text" class="required sm-form-control" id="" name="engine" rows="2" cols="30" value="<?php echo "$engine" ; ?>">
							</div>
							<div class="col-md-4 bottommargin-sm">
								<label for="">Millage <small>*</small></label>
								<input type="text" class="required sm-form-control" id="" name="millage" rows="2" cols="30" value="<?php echo "$millage" ; ?>">
							</div>
							<div class="row">	
