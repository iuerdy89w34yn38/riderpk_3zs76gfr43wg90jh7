...
<head>
	...
	<meta name="description" content="Cars, New Cars Details, New Bikes Details,New Heavy Bikes Details,Honda cars in Pakistan,Toyota cars in Pakistan  " />
...
<meta property="og:description" content="Cars,New Cars Details,Honda cars in Pakistan,Toyota cars in Pakistan  "/>
				...
				<div class="container clearfix">
					...
					<div class="postcontent nobottommargin col_last clearfix">
						...
						<?php	
							...
							$sql = "SELECT * FROM carposts ORDER BY created desc LIMIT 10";
							...
							<div class="entry clearfix">
								<div class="entry-image" data-animate="bounceInRight">
								...
								<div class="entry-c">
									...
									<li style="text-transform:uppercase;"><i class="icon-cogs"></i><?php echo $row['transmission'] ?> Transmission</li>
									</ul>
					...
					<a href="searchcars-Honda" class="button" >Search More !</a>
